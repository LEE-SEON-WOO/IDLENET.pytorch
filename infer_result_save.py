...
if __name__ == '__main__':
    def main():
        ...
        path_to_input_image = os.path.join(path_dir+args.input)
        path_to_output_image = os.path.join(path_dir+args.output)
        path_to_input_csv = os.path.join(path_dir+args.csv_input)
        path_to_input_xml = os.path.join(path_dir+args.xml_input)
        path_to_output_json = os.path.join(path_dir+args.json_result)
        ...
        path_to_checkpoint = os.path.join(path_dir+args.checkpoint)
